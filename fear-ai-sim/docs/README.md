...
The following documents are explicitly historical-superseded and must not be used as current release certification: `CUSTOM_ENGINE_INTEGRATION_SPEC.md`, `NEW_MASTER_GAME_INTEGRATION_AUDIT_DOSSIER.md`, `NEW_MASTER_GAME_LOGIC_ANALYSIS_DOSSIER.md`, `NEW_MASTER_GAME_ROUND2_DEEP_CLAIMS_AUDIT.md`, `FAILURE_AND_LIFECYCLE_MATRIX.md`, and the `audit/v8-current/` candidate records.
