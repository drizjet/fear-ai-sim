...
- Superseded records: `docs/CUSTOM_ENGINE_INTEGRATION_SPEC.md`, `docs/NEW_MASTER_GAME_INTEGRATION_AUDIT_DOSSIER.md`, `docs/NEW_MASTER_GAME_LOGIC_ANALYSIS_DOSSIER.md`, `docs/NEW_MASTER_GAME_ROUND2_DEEP_CLAIMS_AUDIT.md`, and `docs/FAILURE_AND_LIFECYCLE_MATRIX.md` are historical and must not be used to promote the current provisional verdict.
