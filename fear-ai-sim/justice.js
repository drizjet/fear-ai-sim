...
export class JusticeSystem {
    resolve({ legitimacy = 0.5, grievance = 0.5, reportedCrime = true, investigationQuality = 0.5, corruption = 0, lawPenalty = 0 } = {}) {
        ...
        const nextLegitimacy = clamp(legitimacy + (justiceAccess - 0.5) * 0.4 - (reportedCrime ? corruption * 0.2 : 0) - (reportedCrime ? lawDebit : 0));
