 ...
 *
 * Verifies all 7 behavioral stations in official Godot 4.6 console binary:
...
describe('Front A / Section 6: Godot 4.6 Multi-Station Showcase Verification', () => {
  ...
  it('executes all 7 showcase stations headlessly with 100% pass rate', () => {
    if (!godotExe) {
    ...
    expect(output).toContain('GODOT 4.6 MULTI-STATION SHOWCASE CONFORMANCE: 7 / 7 PASSED (100%)');
